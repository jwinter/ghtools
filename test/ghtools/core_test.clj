...
(deftest testing-pulls
  (testing "pulls"
    (let [sample-pulls (pulls "jwinter" "test-repo")]
         ...
         (is (= "jwinter/test-repo: <https://github.com/jwinter/test-repo/pull/1|More detail in the README>\n"
  ...
  (testing "open-pulls-from-repos"
    (is (= (open-pulls-from-repos ["jwinter/test-repo" "jwinter/second-test-repo"])
           (str
            "*Open Pull Requests*\n"
            "jwinter/test-repo: <https://github.com/jwinter/test-repo/pull/1|More detail in the README>\n"
            "jwinter/second-test-repo: <https://github.com/jwinter/second-test-repo/pull/1|Add a README>\n" )))))
